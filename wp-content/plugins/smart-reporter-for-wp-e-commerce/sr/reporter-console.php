...
function sr_create_snapshot_tables() {
...
if ( !isset($_GET['view']) && ( isset($_GET['page']) && $_GET['page'] == 'wc-reports') && ( !empty($sr_const['is_woo22']) && $sr_const['is_woo22'] == "true" ) ) {
    ...
    if(  $wpdb->get_var("SHOW TABLES LIKE '$table_name'") != $table_name
        || $wpdb->get_var("SELECT COUNT(*) FROM {$wpdb->prefix}woo_sr_orders") == 0 ) {
...
<div id="sr_cumm_date" style="height:3em;width:97.85%">
    <div id="sr_cumm_date1" class="sr_cumm_date" style="width:35em;">
        <form>
            ...
            <div id ="sr_custom_date">
                <input type ="text" id="sr_start_date" size="8" placeholder="yyyy-mm-dd" class = "sr_date_range from sr_cumm_date_picker" >
                <label class = "sr_cumm_date_label"> <?php _e('to', $sr_text_domain); ?> </label>
                <input type = "text" id="sr_end_date" size="8" placeholder="yyyy-mm-dd" class = "sr_date_range to sr_cumm_date_picker" >
