...
if ( ! class_exists( 'Flippercode_Product_Overview' ) ) {
	...
	class Flippercode_Product_Overview {
		...
		function __construct($pluginInfo) {
			...
			$this->commonBlocks = array( 'product-activation','newsletter','product-support','suggestion-area','refund-block','extended-support' );
		...
		function setup_plugin_info($pluginInfo) {
			...
			$googlemap = array( 'text-domain' => 'wpgmp_google_map','img' => '1.png','url' => 'http://codecanyon.net/item/advanced-google-maps-plugin-for-wordpress/5211638' );
			$gmap_cf7 = array( 'text-domain' => 'cf7gm_google_map','img' => '2.png','url' => 'http://codecanyon.net/item/google-maps-integration-using-contact-form-7/9689105' );
			...
			$was_this_helpful = array( 'text-domain' => 'was_this_helpful','img' => '7.png','url' => 'http://codecanyon.net/item/was-this-helpful/7415852' );
			$word_highlighter = array( 'text-domain' => '','img' => '8.png','url' => '' );
			$wp_custom_emails = array( 'text-domain' => 'wp_custom_emails','img' => '9.png','url' => 'http://codecanyon.net/item/wordpress-custom-emails/5836005' );
			...
			$wppostspro = array( 'text-domain' => 'wp_posts_pro','img' => '12.png','url' => 'http://codecanyon.net/item/wordpress-posts-listing-plugin/7292195' );
			$wpsecurityquestion = array( 'text-domain' => 'wp_security_question','img' => '13.png','url' => 'http://codecanyon.net/item/wordpress-security-questions/5894819' );
			$useravatar = array( 'text-domain' => 'wp-user-avatar-pro','img' => '14.png','url' => 'http://codecanyon.net/item/wp-user-avatar-pro/15638832' );
			$pushnotification = array( 'text-domain' => 'wp_push_notifications_pro','img' => '15.png','url' => 'http://codecanyon.net/item/wp-push-notifications-pro/16019774' );
			$automaticUpdates = array( 'text-domain' => 'wp_updates_pro','img' => '16.png','url' => 'http://codecanyon.net/item/automatic-updates-for-premium-plugins-themes/15948773' );
			$storeLocator = array( 'text-domain' => 'wc_store_locator','img' => '17.png','url' => 'http://codecanyon.net/item/wordpress-store-locator/15672329' );
			/*
