 ...
 * @since 2.0.0
 */
class PW_COST_GOOD_ADMIN_REPORT_Profit_by_Date extends PW_COST_GOOD_ADMIN_REPORT {
	...
	public function get_chart_legend() {
		...
		return array(
			...
			array(
				...
				'title'            => sprintf( __( '%1$s net sales in this period', PW_COST_GOOD_TEXTDOMAIN ), '<strong>' . wc_price( $data->net_sales ) . '</strong>' ),
				'placeholder'      => __( 'This is the sum of the order totals after any refunds and excluding fees, taxes, and shipping (unless you have toggled the settings to include them)', PW_COST_GOOD_TEXTDOMAIN ),
			...
			array(
				...
				'placeholder'      => __( 'This is the sum of the item cost of goods after any refunds', PW_COST_GOOD_TEXTDOMAIN ),
			...
			array(
				...
				'title'            => sprintf( __( '%1$s total profit in this period', PW_COST_GOOD_TEXTDOMAIN ), '<strong>' . wc_price( $data->total_profit ) . '</strong>' ),
				'placeholder'      => __( 'This is the sum of the order profit after any refunds', PW_COST_GOOD_TEXTDOMAIN ),
			...
			array(
				...
				'title' => sprintf( __( '%1$s orders placed', PW_COST_GOOD_TEXTDOMAIN ), '<strong>' . $data->total_orders . '</strong>' ),
			...
			array(
				...
				'title'            => sprintf( __( '%1$s average profit per order in this period', PW_COST_GOOD_TEXTDOMAIN ), '<strong>' . wc_price( $data->avg_profit ) . '</strong>' ),
				'placeholder'      => __( 'This is the average profit per order after any refunds', PW_COST_GOOD_TEXTDOMAIN ),
		...
		<script type="text/javascript">
			...
			jQuery(function(){
				...
				var drawGraph = function( highlight ) {
					var series = [
						{
							label     : "<?php echo esc_js( __( 'Number of orders', PW_COST_GOOD_TEXTDOMAIN ) ) ?>",
						...
						{
							label     : "<?php echo esc_js( __( 'Net Sales amount', PW_COST_GOOD_TEXTDOMAIN ) ) ?>",
	...
	protected function get_report_data() {
		 ...
		 * @param \PW_COST_GOOD_ADMIN_REPORT_Profit_by_Date $this instance
		 */
