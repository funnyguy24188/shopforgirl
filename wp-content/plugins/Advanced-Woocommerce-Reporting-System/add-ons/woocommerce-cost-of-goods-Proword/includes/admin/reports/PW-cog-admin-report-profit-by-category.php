 ...
 * @since 2.0.0
 */
class PW_COST_GOOD_ADMIN_REPORT_Profit_by_Category extends PW_COST_GOOD_ADMIN_REPORT {
	...
	public function get_chart_legend() {
		...
		foreach ( $this->category_ids as $category_id ) {
			...
			$legend[] = array(
				...
				'title'            => sprintf( __( '%1$s total profit in %2$s', PW_COST_GOOD_TEXTDOMAIN ), '<strong>' . wc_price( ( ! empty( $data->total_profit ) ? $data->total_profit : 0 ) ) . '</strong>', $category->name ),
	...
	public function get_chart_widgets() {
		...
		return array(
			array(
				'title'    => __( 'Categories', PW_COST_GOOD_TEXTDOMAIN ),
	...
	public function output_category_widget() {
		...
		<form method="GET">
			<div>
				<select multiple="multiple" data-placeholder="<?php _e( 'Select categories&hellip;', PW_COST_GOOD_TEXTDOMAIN ); ?>" class="wc-enhanced-select" id="category_ids" name="category_ids[]" style="width: 205px;">
					<?php
					$r                 = array();
					$r['pad_counts']   = 1;
					$r['hierarchical'] = 1;
				...
				<a href="#" class="select_none"><?php esc_html_e( 'None', PW_COST_GOOD_TEXTDOMAIN ); ?></a>
				<a href="#" class="select_all"><?php esc_html_e( 'All', PW_COST_GOOD_TEXTDOMAIN ); ?></a>
	...
	public function get_main_chart() {
		...
		if ( empty( $this->category_ids ) ) {
			...
			<div class="chart-container">
				<p class="chart-prompt"><?php _e( '&larr; Choose a category to view stats', PW_COST_GOOD_TEXTDOMAIN ); ?></p>
			</div>
			<?php
		}
	...
	protected function get_report_data( $category_id ) {
		 ...
		 * @param \PW_COST_GOOD_ADMIN_REPORT_Profit_by_Category $this instance
		 */
