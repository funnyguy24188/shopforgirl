...
if ( ! class_exists( 'PW_COST_GOOD_ADMIN_HANDLER_JOB_BACKG' ) ) :

abstract class PW_COST_GOOD_ADMIN_HANDLER_JOB_BACKG extends PW_COST_GOOD_ADMIN_REQUEST_ASYNC {
	 ...
	 *
	 * @since 4.4.0
	 * @return \PW_COST_GOOD_ADMIN_HANDLER_JOB_BACKG
	 */
