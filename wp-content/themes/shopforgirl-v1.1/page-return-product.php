...
<div id="content" class="container">
    <div class="tutorial">
        <strong>Nhập số hóa đơn, load hóa đơn từ hệ thống để trả hàng. Số lượng trả lại phải nhỏ hơn hoặc bằng số lượng
            trên hóa đơn.
        </strong>
    </div>
            ...
            <div class="row">
                <div class="col-xs-24 col-sm-24 col-md-6">
                    <div class="order-customer-info-block-1">
                        ...
                        <p><strong>Tên khách hàng: <span class="order-general-item order-customer-name"></span></strong>
                        </p>
                    </div>
                </div>
                <div class="col-xs-24 col-sm-24 col-md-6">
                    <div class="order-customer-info-block-2">
                        ...
                        <p><strong>Điện thoại: <span class="order-general-item order-customer-phone"></span></strong>
                        </p>
                ...
                <div class="col-xs-24 col-sm-24 col-md-6">
                    <div class="order-customer-info-block-3">
                        ...
                        <p><strong>Trạng thái: <span
                                        class="order-general-item order-status-icon order-status"></span></strong></p>
                    </div>
                </div>
            </div>
