...
<div id="order-page-header" class="titleclass">
    <div class="container">
        <?php if (have_message()): ?>
            <div class="alert alert-dismissible <?php echo((get_message_type() == 'error') ? 'alert-danger' : '') ?>"
...
<div id="content" class="container">
    <div class="row">
        <div class="main col-sm-24 col-md-24" role="main">
            <div class="entry-content" id="order-page" itemprop="mainContentOfPage">
                <div class="order-form-wrap">
                    <form id="order-form" method="post" action="" class="form-horizontal">
                        <section id="product-master-info" class="col-xs-24 col-sm-15">
                            <fieldset id="product-barcode-scanner" title="product-barcode-scanner">
                                ...
                                <div class="form-group col-sm-24 col-md-24">
                        ...
                        <section id="customer-master-info" class="col-xs-12 col-sm-9">
                            <fieldset id="customer-info" title="customer-info">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-24 col-sm-24 customer-shipping-address-group">
                                    ...
                                    <div class="col-xs-24 col-sm-24 customer-shipping-fee-group">
                                    ...
                                    <div class="col-xs-18 col-sm-18 customer-payment-status-group">
                                    ...
                                    <div class="col-xs-24 col-sm-24 customer-money-payment-group">
                                    ...
                                    <div class="col-xs-24 col-sm-24 customer-save-order-group">
