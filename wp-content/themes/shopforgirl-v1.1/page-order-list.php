...
<div id="content" class="container order-list">
    ...
    <div class="row">
        <form class="form-horizontal" id="order-list-search-form">
            ...
            <div class="row">
                <div class="col-md-24 filter-wrapper">
                    <div class="col-md-12 date-filter-box-wrapper">
                    ...
                    <div class="col-md-8 search-box-wrapper">
                            ...
                            <?php if (is_array($order)): ?>
                                ...
                                <span
                                    ...
                                    <td style="width: 250px;">
                                        <a href="#" data-order-id="<?php echo $order_id ?>"
                                           class="print-order-detail"><i
