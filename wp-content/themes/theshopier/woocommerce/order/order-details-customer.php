		...
		<div class="address-wrapper">
			...
			<div class="col2-set addresses">
				<div class="col-1">
					...
					<address>
						<?php echo ( $address = $order->get_formatted_billing_address() ) ? $address : esc_html__( 'N/A', 'theshopier' ); ?>
					</address>
				...
				<div class="col-2">
					...
					<address>
						<?php echo ( $address = $order->get_formatted_shipping_address() ) ? $address : esc_html__( 'N/A', 'theshopier' ); ?>
					</address>
				</div><!-- /.col-2 -->
			</div><!-- /.col2-set -->
