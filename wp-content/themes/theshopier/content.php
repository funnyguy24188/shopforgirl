...
<li <?php post_class(implode( ' ', $_class ));?> >
	<div class="post-item-content">
		<?php if( !absint($_use_thumb) && !empty($post_options['nth_post_shortcode']) ) :?>

			<div class="post-thumbnail">
				<?php echo do_shortcode(stripslashes(htmlspecialchars_decode($post_options['nth_post_shortcode'])));?>
			</div>
