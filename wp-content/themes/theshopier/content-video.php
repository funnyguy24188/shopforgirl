	...
	<div class="post-item-content">
		...
		<?php else:?>
			...
			if( isset($post_options['nth_source_type']) ):?>
				<?php if( strcmp( trim($post_options['nth_source_type']), 'online' ) == 0 ):?>
				<div class="post-thumbnail post-video">
					<?php theshopier_video_player( apply_filters('theshopier_post_content_video_data', array(
						'url'		=> trim($post_options['nth_onl_url']),
						'width'		=> 870,
						'height' 	=> 492
					)) );?>
				</div>
