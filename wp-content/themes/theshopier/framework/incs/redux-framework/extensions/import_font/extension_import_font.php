...
// Don't duplicate me!
if( !class_exists( 'ReduxFramework_extension_import_font' ) ) {
     ...
     * @since       3.1.6
     */
    class ReduxFramework_extension_import_font extends ReduxFramework {
        ...
        */
        public function __construct( $parent ) {
            ...
            if ( empty( $this->extension_dir ) ) {
                $extension_dir = get_template_directory() . '/framework/incs/redux-framework/extensions/import_font';
                $this->extension_dir = trailingslashit( str_replace( '\\', '/', $extension_dir ) );
            }
            $this->field_name = 'import_font';
